...
object DeviceConfig {
    ...
    /** 开始唤醒辅助验证点 (51%, 66%) — 浅灰背景R>220 */
    val WAKE_ASSIST = PctCoord(51f, 66f)
    
    /** 开始唤醒点击位置 (51%, 69%) */
    val WAKE_CLICK = PctCoord(51f, 69f)
    ...
    /** 开始唤醒灰按钮: R在55-115范围（≈85±30） */
    val COLOR_WAKE_GRAY = ColorRule("开始唤醒灰", { it in 55..115 }, { it in 55..115 }, { it in 55..115 })
